    ...
    public partial class cv : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TankRegions", x => new { x.TankId, x.RegionId });
                    table.ForeignKey(
                        name: "FK_TankRegions_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TankRegions_Tanks_TankId",
                        column: x => x.TankId,
            ...
            migrationBuilder.InsertData(
                table: "Tanks",
                columns: new[] { "Id", "Capacity", "Location", "Name", "PricePerBarrel", "WaterType" },
                values: new object[,]
                {
                    { 1, 1000, "البارة", "خزان الشفا", 50.00m, "مياه شرب" },
                    { 2, 800, "كنصفرة", "خزان النور", 45.00m, "مياه شرب" },
                    { 3, 1200, "الفطيرة", "خزان الحياة", 55.00m, "مياه شرب" }
                });

            migrationBuilder.InsertData(
                table: "TankRegions",
                columns: new[] { "RegionId", "TankId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 2, 1 },
